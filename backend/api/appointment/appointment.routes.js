...
const { getCustomerAppointments, getEmployeeAppointments, getCustEmployeeRevenue, addAppointment, updateAppointment, removeAppointment, getNextAppointments, getNextTreatments, getCustomerAppointmentsByDay } = require('./appointmentController')
